...
for i, char in enumerate(romaji):
    ...
    if is_plain:
        ...
        if char.startswith("A") or char.startswith("I") or char.startswith("U") or char.startswith("E") or char.startswith("O"):
            gojuon_col = 0
